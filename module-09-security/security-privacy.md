---
banner: images/module-09-banner.png
thumbnail: images/module-09-banner.png
---
...
1. **[Security, Privacy, and Trust](security-privacy-and-trust.md)** - What information security is, the CIA triad, how privacy differs from security, and the 23andMe case study where all three failed at once
2. **[Common Security Threats and Defenses](threats-and-defenses.md)** - How phishing, social engineering, password attacks, and ransomware actually work, and the layered defenses that stop them
3. **[Privacy in Practice](privacy-in-practice.md)** - What's collected about you, the data economy, how to audit a privacy policy, the patchwork of privacy law, and trust as a design decision
...
Start with [Security, Privacy, and Trust](security-privacy-and-trust.md) to get the core concepts straight, then see how attacks actually work and how to layer your defenses in [Common Security Threats and Defenses](threats-and-defenses.md), and finish with [Privacy in Practice](privacy-in-practice.md) to follow what happens to your data even when nothing is "hacked" at all.
