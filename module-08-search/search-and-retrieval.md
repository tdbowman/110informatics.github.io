...
1. **[Information Retrieval Foundations](ir-foundations.md)** - What IR is, how knowledge is organized for retrieval, and how search success is measured
2. **[How Search Engines Work](how-search-engines-work.md)** - Crawling, indexing, query processing, and ranking, under the hood
3. **[Search After Generative AI](search-after-ai.md)** - AI Overviews, answer engines, RAG, and *United States v. Google*
...
Start with [Information Retrieval Foundations](ir-foundations.md) to see how the finding-things problem predates the web, then open the hood in [How Search Engines Work](how-search-engines-work.md), and finish with [Search After Generative AI](search-after-ai.md) to see how the results page is being reinvented right now.
