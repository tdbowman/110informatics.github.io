---
banner: images/module-11-banner.png
thumbnail: images/module-11-banner.png
---
...
| Coverage of the Cruise incident and shutdown | The [case study](what-makes-a-system-autonomous.md), in depth |
...
1. **[What Makes a System Autonomous?](what-makes-a-system-autonomous.md)** - The automated/autonomous/AI distinction, the four D's, the SAE levels, and the Waymo vs. Cruise case study
2. **[Autonomous Systems in Action](autonomous-systems-in-action.md)** - Where autonomy is deployed today and the perceive → localize → plan → act pipeline that powers it
3. **[Challenges and Ethics of Autonomy](challenges-and-ethics.md)** - The six challenges every autonomous system faces, the trolley problem revisited, and employment implications
...
Begin with [What Makes a System Autonomous?](what-makes-a-system-autonomous.md) to get the definitions, the levels, and the Waymo/Cruise story, then see the technology deployed and dissected in [Autonomous Systems in Action](autonomous-systems-in-action.md), and finish with [Challenges and Ethics of Autonomy](challenges-and-ethics.md) to weigh what it all means for society.
