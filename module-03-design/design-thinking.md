...
A non-linear, iterative process involving five phases:
...
5. **Test**: Try solutions with real users

### HCI, UCD, UI, & UX

| Term | Meaning |
|------|---------|
| **HCI** | Human-Computer Interaction: academic study of how people interact with technology |
| **UCD** | User-Centered Design: designing with the user's needs as primary focus |
...
Computing that relates to, arises from, or deliberately influences emotion. UX focuses on:
