---
banner: images/module-02-banner.png
thumbnail: images/module-02-banner.png
---
...
1. **[Thinking in Systems](thinking-in-systems.md)** - Systems thinking and the six components every information system depends on, from hardware and software to procedures and people
2. **[How the Internet Works](how-the-internet-works.md)** - Packets, DNS, TCP/IP, and the cables, routers, exchange points, and towers that carry a click around the world
3. **[Costs and the Digital Divide](costs-and-the-digital-divide.md)** - The energy, resource, and social costs of digital infrastructure, and the three divides that determine who benefits
...
Start with [Thinking in Systems](thinking-in-systems.md) to pick up the habit of mind this week depends on, then follow a click across the planet in [How the Internet Works](how-the-internet-works.md), and finish with [Costs and the Digital Divide](costs-and-the-digital-divide.md) to ask who pays for all this infrastructure and who gets left out.
