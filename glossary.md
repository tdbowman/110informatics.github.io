...
Key terms you'll encounter throughout this course.

---

**Accessibility**
: The design of products, devices, services, or environments so they can be used by people with disabilities. In technology, this includes screen readers, keyboard navigation, and other accommodations. (Module 5)
...
: The simulation of human intelligence processes by machines, especially computer systems. This includes learning, reasoning, and self-correction. (Module 12)
...
**Data Analytics**
: The process of examining datasets to draw conclusions and identify patterns. (Module 6)

**Data Breach**
: An incident in which protected information is accessed, copied, or exposed without authorization. (Module 9)

**Data Science**
: An interdisciplinary field using scientific methods, algorithms, and systems to extract knowledge from structured and unstructured data. (Module 6)

**Data Visualization**
: The graphical representation of data and information using charts, graphs, maps, and other visual elements. (Module 7)
...
**Design Thinking**
: A non-linear, iterative process that teams use to understand users, challenge assumptions, redefine problems, and create innovative solutions. (Module 3)

**Digital Divide**
: The gap between those who have access to modern information and communication technology and those who do not. (Module 2)
...
**Infographic**
: A visual representation of information designed to present complex information quickly and clearly to a general audience. (Module 7)
...
**Neural Network**
: A machine-learning model loosely inspired by the brain: layers of simple units that, trained together, can recognize patterns of astonishing complexity. (Module 12)

**Phishing**
: Fraudulent messages that impersonate trusted senders to trick you into revealing information or clicking malicious links. (Module 9)

**Privacy**
: The right of individuals to control their personal information and how it is collected, used, and shared. (Module 9)
...
**Security**
: The protection of information and systems from unauthorized access, use, disclosure, disruption, modification, or destruction. (Module 9)

**Semantic Search**
: Search that matches *meanings* rather than exact words, typically using embeddings. (Module 8)

**SEO (Search Engine Optimization)**
: The practice of improving a website to increase its visibility in search engine results. (Module 8)

**Signifier**
: A visual or auditory cue that communicates how something should be used. Distinct from affordance. (Module 3)

**SQL (Structured Query Language)**
: A programming language used to communicate with and manipulate relational databases. (Module 4)

**UI (User Interface)**
: The visual elements through which a user interacts with a computer system or application. (Module 3)

**UX (User Experience)**
: The overall experience a person has when using a product or system, including how easy, efficient, and pleasant it is to use. (Module 3)
