---
banner: images/module-13-banner.png
thumbnail: images/module-13-banner.png
---
...
1. **[Robots, Games, and Embodied AI](robots-and-embodied-ai.md)** - Moravec's paradox, the state of robotics in mid-2026, and how game engines became the gyms where robots train
2. **[AI Agents: Autonomy Without a Body](ai-agents.md)** - What agents are, the autonomy dial, the accountability question, and the design-an-agent group exercise
...
Start with [Robots, Games, and Embodied AI](robots-and-embodied-ai.md) to see why the physical world humbles AI and how video games became robotics' training ground, then finish with [AI Agents: Autonomy Without a Body](ai-agents.md) to decide how much you'd let software act on your behalf.
