---
banner: images/module-05-banner.png
thumbnail: images/module-05-banner.png
---
...
1. **[Understanding Disability & Why It Matters](understanding-disability.md)** - How disability is defined (medical vs. social models), the numbers behind it, and how Section 508, the ADA, and WCAG fit together
2. **[Assistive Technology & Inclusive Design](assistive-tech-and-inclusive-design.md)** - Screen readers, switch access, and captions; accessible vs. inclusive design; the curb-cut effect and universal design
3. **[WCAG, Testing & Everyday Etiquette](wcag-testing-and-etiquette.md)** - The POUR principles and their success criteria, quick accessibility tests, and respectful language and etiquette
...
Begin with [Understanding Disability & Why It Matters](understanding-disability.md) to see how disability is defined and why accessibility is law as well as ethics, then meet the tools and design philosophies in [Assistive Technology & Inclusive Design](assistive-tech-and-inclusive-design.md), and finish with the standard you'll actually build to in [WCAG, Testing & Everyday Etiquette](wcag-testing-and-etiquette.md).
