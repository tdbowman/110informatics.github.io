---
banner: images/module-06-banner.png
thumbnail: images/module-06-banner.png
---
...
1. **[Analytics vs. Data Science](analytics-vs-data-science.md)** - What the two fields (and the two job titles) actually do, the four types of analytics, and where analytics hides in your daily life
2. **[Statistics Foundations](statistics-foundations.md)** - The vocabulary of data: variables, levels of measurement, samples vs. populations, and why correlation is not causation
3. **[The Analysis Process, AI, and Bias](analysis-process-and-bias.md)** - The six-step analysis process, AI copilots, how bias gets into data, and practice datasets to explore
...
Start with [Analytics vs. Data Science](analytics-vs-data-science.md) to map the field and the people who work in it, then build your vocabulary in [Statistics Foundations](statistics-foundations.md), and finish with [The Analysis Process, AI, and Bias](analysis-process-and-bias.md) to see how analysis actually gets done, and how it goes wrong.
