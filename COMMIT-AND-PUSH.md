# Publishing the Winter 2027 textbook refresh (from this VS Code clone)
...
To publish, open the terminal in VS Code and run:
    ...
    git add -A
    git commit -m "Winter 2027 refresh: currency corrections, AI thread, Module 13, meaningful URLs, working notebook"
    git push
